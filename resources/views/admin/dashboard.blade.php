                            ...
                            <div class="row">
                                <div class="col-8">
                                    <div class="mt-0 text-start"><span
                                            class="fs-14 font-weight-semibold">{{ trans('langconvert.adminmenu.alltickets') }}</span>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
                                    <div class="mt-0 text-start"> <span
                                            class="fs-14 font-weight-semibold">{{ trans('langconvert.adminmenu.activetickets') }}</span>
                                        <h3 class="mb-0 mt-1  mb-2">{{ $active->count() }}</h3>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="icon1 bg-primary brround my-auto  float-end"> <i
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
                                    <div class="mt-0 text-start"> <span
                                            class="fs-14 font-weight-semibold">{{ trans('langconvert.adminmenu.closetickets') }}</span>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
                                    <div class="mt-0 text-start"> <span
                                            class="fs-14 font-weight-semibold">{{ trans('langconvert.adminmenu.onholdtickets') }}</span>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
                                    <div class="mt-0 text-start"><span
                                            class="fs-14 font-weight-semibold">{{ trans('langconvert.adminmenu.mytickets') }}</span>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
                                    <div class="mt-0 text-start"> <span
                                            class="fs-14 font-weight-semibold">{{ trans('langconvert.adminmenu.assigntickets') }}</span>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
                                    <div class="mt-0 text-start"><span
                                            class="fs-14 font-weight-semibold">{{ trans('langconvert.adminmenu.myassigntickets') }}</span>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
                                    <div class="mt-0 text-start"> <span
                                            class="fs-14 font-weight-semibold">{{ trans('langconvert.adminmenu.overduetickets') }}</span>
