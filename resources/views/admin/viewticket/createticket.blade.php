    ...
    <div class="page-header d-xl-flex d-block">
        <div class="page-leftheader">
            <h4 class="page-title"><span
                    class="font-weight-normal text-muted ms-2">{{ trans('langconvert.adminmenu.createticket') }}</span></h4>
        </div>
    </div>
    <!--End Page header-->
            ...
            <form method="post" id="admin_form" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group ">
                        <div class="row">
                            <div class="col-md-3">
                                <label class="form-label mb-0 mt-2">{{ trans('langconvert.admindashboard.ticketsubject') }}
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-3">
                                <label class="form-label mb-0 mt-2">{{ trans('langconvert.admindashboard.emailaddress') }}
                                    <span class="text-red">*</span></label>
                            </div>
                            <div class="col-md-9">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-3">
                                <label
                                    class="form-label mb-0 mt-2">{{ trans('langconvert.admindashboard.ticketcategory') }}<span
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control select2-show-search  select2"
                                    data-placeholder="Select SubCategory" name="subscategory" id="subscategory">
                    ...
                    <div class="form-group ">
                        <div class="row">
                            <div class="col-md-3">
                                <label class="form-label mb-0 mt-2">Reason
                                    <span class="text-red">*</span></label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" id="reason"
                                    class="form-control @error('subject') is-invalid @enderror" placeholder="Reason"
                                    name="reason" value="{{ old('reason') }}">
                                <span id="ReasonError" class="text-danger alert-message"></span>
                                @error('reason')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="form-group ">
                        <div class="row">
                            <div class="col-md-3">
                                <label class="form-label mb-0 mt-2">Reason Caused By
                                    <span class="text-red">*</span></label>
                            </div>
                            <div class="col-md-9">
                                <select name="reasoncausedby" id="reasoncausedby"
                                    class="form-control @error('reasoncausedby') is-invalid @enderror"
                                    value="{{ old('reasoncausedby') }}">
                                    <option value="System">System</option>
                                    <option value="Typo">Typo</option>
                                    <option value="None">None</option>
                                </select>
                                <span id="ReasoncausedbyError" class="text-danger alert-message"></span>
                                @error('reasoncausedby')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                    ...
                    <div class="form-group ">
                        <div class="row">
                            <div class="col-md-3">
                                <label class="form-label mb-0 mt-2">Loa No
                                    <span class="text-red">*</span></label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" id="loano"
                                    class="form-control @error('loano') is-invalid @enderror" placeholder="Loano"
                                    name="loano" value="{{ old('loano') }}">
                                <span id="LoanoError" class="text-danger alert-message"></span>
                                @error('loano')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="form-group ticket-summernote ">
                        <div class="row">
                            <div class="col-md-3">
                                <label
                                    class="form-label mb-0 mt-2">{{ trans('langconvert.admindashboard.ticketdescription') }}<span
                                        class="text-red">*</span></label>
                            </div>
                            <div class="col-md-9">
                ...
                <div class="card-footer">
                    <div class="form-group float-end">
                        <input type="submit" class="btn btn-secondary btn-lg purchasecode"
                            value="{{ trans('langconvert.adminmenu.createticket') }}">
                    </div>
                </div>
            </form>
        </div>
            ...
            $('body').on('submit', '#admin_form', function(e) {
                ...
                $.ajax({
                    ...
                    success: (data) => {
                        ...
                        if (localStorage.getItem('adminsubject') || localStorage.getItem(
                                'adminmessage') || localStorage.getItem('adminemail')) {
                    ...
                    error: function(data) {
                        ...
                        $('#ReasonError').html(data.responseJSON.errors.reason);
                        $('#ReasoncausedbyError').html(data.responseJSON.errors.reasoncausedby);
                        $('#LoanoError').html(data.responseJSON.errors.loano);
