                          ...
                          <div class="col col-auto">
                              <ol class="breadcrumb text-center">
                                  <li class="breadcrumb-item">
                                      <a href="{{ url('/') }}"
                                          class="text-white-50">{{ trans('langconvert.menu.home') }}</a>
                                  </li>
                                  <li class="breadcrumb-item active">
                                      <a href="#"
                                          class="text-white">{{ trans('langconvert.adminmenu.createticket') }}</a>
                                  </li>
                              </ol>
                          </div>
                      </div>
                                  ...
                                  <div class="card-body">
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-md-9">
                                                  <input type="text" id="reason"
                                                      class="form-control @error('subject') is-invalid @enderror"
                                                      placeholder="Reason" name="reason" value="{{ old('reason') }}">
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-md-9">
                                                  <input type="text" id="loano"
                                                      class="form-control @error('loano') is-invalid @enderror"
                                                      placeholder="Loano" name="loano" value="{{ old('loano') }}">
                                      ...
                                      <div class="form-group ticket-summernote ">
                                          <div class="row">
                                              ...
                                              <div class="col-md-9">
                                                  <textarea class="summernote form-control @error('message') is-invalid @enderror" name="message" rows="4"
                                                      cols="400">{{ old('message') }}</textarea>
                  ...
                  $.ajax({
                      ...
                      success: function(data) {
                          ...
                          if (data.subcategories.length >= 1) {
                              ...
                              selecthSelectTag.setAttribute('class',
              ...
              $('body').on('submit', '#user_form', function(e) {
                  ...
                  $.ajax({
                      ...
                      success: (data) => {
                          ...
                          if (localStorage.getItem('usersubject') || localStorage.getItem(
                                  'usermessage')) {
