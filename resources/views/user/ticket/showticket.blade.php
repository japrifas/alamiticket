                        ...
                        <div class="col col-auto">
                            <ol class="breadcrumb text-center">
                                ...
                                <li class="breadcrumb-item active">
                                    <a href="#"
                                        class="text-white">{{ trans('langconvert.userdashboard.ticketview') }}</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div id="scroll-stickybar" class="w-100 pos-sticky-scroll">
                                    ...
                                    <div class="profile-pic">
                                        <div class="profile-pic-img mb-2">
                                            <span class="bg-success dots" data-bs-toggle="tooltip" data-placement="top"
                                                title="" data-bs-original-title="online"></span>
                                ...
                                <div class="purchasecodes alert alert-light-warning br-13 mb-5">
                                    <div class="ps-0 pe-0 pb-0">
                                        <div class="">
                                            ...
                                            <span
                                                class="">{{ Str::padLeft(Str::substr($ticket->purchasecode, -4), Str::length($ticket->purchasecode), Str::padLeft('*', 1)) }}</span>
                            ...
                            <div class="card">
                                <div class="card-header  border-0">
                                    <div class="card-title">{{ trans('langconvert.admindashboard.ticketinformation') }}
                                    </div>
                                    <input type="hidden" name="" data-id="{{ $ticket->id }}" id="ticket">
                                    <div class="float-end ms-auto"><a href="{{ route('client.ticket') }}"
                                            class="btn btn-white btn-sm ms-auto"><i
                                                class="fa fa-paper-plane-o me-2 fs-14"></i>{{ trans('langconvert.adminmenu.createticket') }}</a>
                                    </div>
                                </div>
                                        ...
                                        <table class="table mb-0 table-information">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <span
                                                            class="w-50">{{ trans('langconvert.admindashboard.ticketid') }}</span>
                                                    </td>
                                                    <td>:</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <span
                                                            class="w-50">{{ trans('langconvert.admindashboard.ticketcategory') }}</span>
                                                    </td>
                                                    <td>:</td>
                                                    <td>
                                                        @if ($ticket->category_id != null)
                                                            <span
                                                                class="font-weight-semibold">{{ $ticket->category->name }}</span>
                                                        @endif
                                                ...
                                                @if ($ticket->subcategory != null)
                                                    <tr>
                                                        <td>
                                                            <span
                                                                class="w-50">{{ trans('langconvert.newwordslang.ticketsubcategory') }}</span>
                                                        </td>
                                                        <td>:</td>
                                                        <td>
                                                            <span
                                                                class="font-weight-semibold">{{ $ticket->subcategories->subcatlists->subcategoryname }}</span>
                                                ...
                                                @if ($ticket->project != null)
                                                    <tr>
                                                        <td>
                                                            <span
                                                                class="w-50">{{ trans('langconvert.admindashboard.ticketproject') }}</span>
                                                        </td>
                                                        <td>:</td>
                                                        <td>
                                                            <span
                                                                class="font-weight-semibold">{{ $ticket->project }}</span>
                                                        </td>
                                                    </tr>
                                                @endif
                                                ...
                                                <tr>
                                                    <td>
                                                        <span
                                                            class="w-50">{{ trans('langconvert.admindashboard.opendate') }}</span>
                                                    </td>
                                                    <td>:</td>
                                                    <td>
                                                        <span
                                                            class="font-weight-semibold">{{ $ticket->created_at->format(setting('date_format')) }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <span
                                                            class="w-50">{{ trans('langconvert.admindashboard.status') }}</span>
                                                    </td>
                                                    <td>:</td>
                                                    <td>
                                                ...
                                                @if ($ticket->replystatus != null)
                                                    <tr>
                                                        <td>
                                                            <span
                                                                class="w-50">{{ trans('langconvert.admindashboard.replystatus') }}</span>
                                                        </td>
                                                        <td>:</td>
                                                        <td>
                                                            @if ($ticket->replystatus == 'Solved')
                                                                <span
                                                                    class="badge badge-success">{{ $ticket->replystatus }}</span>
                                                            @elseif($ticket->replystatus == 'Unanswered')
                                                                <span
                                                                    class="badge badge-danger-light">{{ $ticket->replystatus }}</span>
                                                            @elseif($ticket->replystatus == 'Waiting for response')
                                                                <span
                                                                    class="badge badge-warning">{{ $ticket->replystatus }}</span>
                                                            @else
                                                            @endif
                    ...
                    <div class="col-xl-8">
                        <div class="card">
                            <div class="card-header border-0 mb-1 d-block">
                                ...
                                <small class="fs-13"><i
                                        class="feather feather-clock text-muted me-1"></i>{{ trans('langconvert.admindashboard.lastupdatedon') }}
                                ...
                                <div>
                                    ...
                                    <div class="row galleryopen">
                                        @foreach ($ticket->getMedia('ticket') as $ticketss)
                                            <div class="file-image-1  removespruko{{ $ticketss->id }}"
                                                id="imageremove{{ $ticketss->id }}">
                                                <div class="product-image">
                                                    <a href="{{ $ticketss->getFullUrl() }}" class="imageopen">
                                                        <img src="{{ $ticketss->getFullUrl() }}" class="br-5"
                                                            alt="{{ $ticketss->file_name }}">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                <p>{{ trans('langconvert.userdashboard.ticketclosedreopen') }}
                                                    <input type="submit" class="btn btn-secondary"
                                                        value="{{ trans('langconvert.admindashboard.reopen') }}"
                                ...
                                @else
                                    @if ($ticket->closing_ticket != null)
                                        @if (now()->format('Y-m-d') <= $ticket->closing_ticket->adddays(setting('USER_REOPEN_TIME'))->format('Y-m-d'))
                                            <div class="card">
                                                <form method="POST"
                                                    action="{{ url('customer/closed/' . $ticket->ticket_id) }}">
                                                    @csrf
                                                    @honeypot
                        ...
                        @else
                            <div class="card">
                                ...
                                <form method="POST" action="{{ route('client.comment', $ticket->ticket_id) }}"
                                    ...
                                    <input type="hidden" name="ticket_id" value="{{ $ticket->id }}">
                                    <div class="card-body">
                                        <textarea class="summernote form-control  @error('comment') is-invalid @enderror" name="comment" rows="6"
                                            cols="100" aria-multiline="true"></textarea>
                                        ...
                                        @if (setting('USER_FILE_UPLOAD_ENABLE') == 'yes')
                                            <div class="form-group mt-3">
                                                <label
                                                    class="form-label">{{ trans('langconvert.admindashboard.uploadimage') }}</label>
                                        ...
                                        <div class="custom-controls-stacked d-md-flex mt-3">
                                            <label
                                                class="form-label mt-1 me-5">{{ trans('langconvert.admindashboard.status') }}</label>
                                            <label class="custom-control form-radio success me-4">
                                                @if ($ticket->status == 'Re-Open')
                                                    ...
                                                    <span
                                                        class="custom-control-label">{{ trans('langconvert.newwordslang.inprogress') }}</span>
                                                @elseif($ticket->status == 'Inprogress')
                                                    <input type="radio" class="custom-control-input" name="status"
                                                        value="{{ $ticket->status }}"
                                                        {{ $ticket->status == 'Inprogress' ? 'checked' : '' }}>
                                                    <span
                                                        class="custom-control-label">{{ trans('langconvert.newwordslang.leaveascurrent') }}</span>
                                                @else
                                                    <input type="radio" class="custom-control-input" name="status"
                                                        value="{{ $ticket->status }}"
                                                        {{ $ticket->status == 'New' ? 'checked' : '' }}>
                                                    <span
                                                        class="custom-control-label">{{ trans('langconvert.newwordslang.new') }}</span>
                                                @endif
                                            ...
                                            <label class="custom-control form-radio success">
                                                <input type="radio" class="custom-control-input" name="status"
                                                    value="Closed">
                                                <span
                                                    class="custom-control-label">{{ trans('langconvert.newwordslang.solved') }}</span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                        <div class="form-group float-end">
                                            <input type="submit" class="btn btn-secondary"
                                                value="{{ trans('langconvert.admindashboard.reply') }}"
                                                onclick="this.disabled=true;this.form.submit();">
                                        </div>
                                    </div>
                                </form>
